...
dispatchMouseEvent($0, 'mouseover', true, true);


dispatchMouseEvent($0, 'mousedown', true, true);


dispatchMouseEvent($0, 'click', true, true);


dispatchMouseEvent($0, 'mouseup', true, true);
